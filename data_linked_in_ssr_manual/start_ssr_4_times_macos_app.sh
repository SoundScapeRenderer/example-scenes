...
open -n -a SoundScapeRenderer --args --brs "--fudi-server=1147 --input-prefix=XXX:XXX --output-prefix=YYY:YYY --name=loudspeakers_1-2 ~/Documents/misc/ssr/loudspeakers_1-2.asd"

# Start SSR 2, loudspeakers 3-4
open -n -a SoundScapeRenderer --args --brs "--fudi-server=1148 --input-prefix=XXX:XXX --output-prefix=YYY:YYY --name=loudspeakers_3-4 ~/Documents/misc/ssr/loudspeakers_3-4.asd"

# Start SSR 3, loudspeakers 4-5
open -n -a SoundScapeRenderer --args --brs "--fudi-server=1149 --input-prefix=XXX:XXX --output-prefix=YYY:YYY --name=loudspeakers_5-6 ~/Documents/misc/ssr/loudspeakers_5-6.asd"

# Start SSR 4, loudspeakers 6-7
open -n -a SoundScapeRenderer --args --brs "--fudi-server=1150 --input-prefix=XXX:XXX --output-prefix=YYY:YYY --name=loudspeakers_7-8 ~/Documents/misc/ssr/loudspeakers_7-8.asd"
