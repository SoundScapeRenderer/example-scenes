...
ssr-brs --fudi-server=1147 --input-prefix=XXX:XXX --output-prefix=YYY:YYY --name=loudspeakers_1-2 loudspeakers_1-2.asd &

# Start SSR 2, loudspeakers 3-4
ssr-brs --fudi-server=1148 --input-prefix=XXX:XXX --output-prefix=YYY:YYY --name=loudspeakers_3-4 loudspeakers_3-4.asd &

# Start SSR 3, loudspeakers 4-5
ssr-brs --fudi-server=1149 --input-prefix=XXX:XXX --output-prefix=YYY:YYY --name=loudspeakers_5-6 loudspeakers_5-6.asd &

# Start SSR 4, loudspeakers 6-7
ssr-brs --fudi-server=1150 --input-prefix=XXX:XXX --output-prefix=YYY:YYY --name=loudspeakers_7-8 loudspeakers_7-8.asd &
